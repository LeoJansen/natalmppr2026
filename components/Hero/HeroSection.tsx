...
export function HeroSection() {
    ...
    return (
        <section className="relative overflow-hidden h-screen bg-[#080A16] text-white shadow-[0_40px_120px_rgba(5,6,15,0.55)]">
            ...
            <div className="relative z-10 w-full h-full flex flex-col justify-between gap-8 px-8 py-12 md:px-14 md:py-16 lg:px-20">
                <div className="flex flex-col gap-8 ">
                    ...
                    <div className="flex flex-col  justify-between items-between h-full gap-8 lg:gap-16">
                        ...
                        <div className="">
                            <p className="inline-flex items-center gap-2 rounded-full border-2 border-[#EB9E50] px-8 py-4 text-lg text-white/85">
